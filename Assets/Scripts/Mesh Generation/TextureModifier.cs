...
public class TextureModifier : MonoBehaviour {
	...
	void CreateTexture() {
		...
		//Color c = inputTexture.GetPixelBilinear(0,0);
		...
		for (int index = 0; index < width * height; index++) {
            ...
            switch (pattern) {
				case ModificationType.Normal:
					...
					break;
				case ModificationType.inverted:
					Color col = inputTexture.GetPixelBilinear(newU, newV);// inputColors[index];
					output = new Color (1 - col.r, 1 - col.g, 1 - col.b);
					break;
